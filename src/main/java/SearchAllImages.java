...
public class SearchAllImages {
    ...
    public static void main(String... args) throws IOException, GeneralSecurityException {
        ...
        do{
           ...
           // incomplete = result.getIncompleteSearch();
            ...
            if (files == null || files.isEmpty()) {
                ...
                for (File file : files) {
                    ...
                    System.out.println("Image: "+file.getImageMediaMetadata());

//                    System.out.println("ContentHints: "+file.getContentHints());
